...
export const defaultAppName = "Aidea";
export const defaultAppLogo = "/aidea-icon.svg";
...
updateDocumentTitle(import.meta.env.VITE_APP_NAME || defaultAppName);
updateFavicon(import.meta.env.VITE_APP_LOGO || defaultAppLogo);
...
export function setBlobEndpoint(endpoint: string): void {
   ...
   */
  endpoint = endpoint.trim() || "/api/file";
