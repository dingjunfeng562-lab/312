      ...
      className={cn(
        "w-5 h-5 p-1 rounded-sm ml-1.5 hover",
        {
          ...
          "text-yellow-600 bg-yellow-500/20 hover:bg-yellow-500/30":
            props.variant === "fast" || props.variant === "response-fast",
          "text-sky-600 bg-sky-500/20 hover:bg-sky-500/30":
            props.variant === "response-standard",
          "text-orange-600 bg-orange-500/20 hover:bg-orange-500/30":
            props.variant === "response-slow" || props.variant === "unstable",
          "text-slate-600 bg-slate-500/20 hover:bg-slate-500/30":
            props.variant === "model-chat",
          "text-fuchsia-600 bg-fuchsia-500/20 hover:bg-fuchsia-500/30":
            props.variant === "model-image",
          "text-violet-600 bg-violet-500/20 hover:bg-violet-500/30":
            props.variant === "model-video",
